...
const Sidebar = () => {
  return (
    <>
      <aside
        id='logo-sidebar'
        className={`fixed top-0 left-0 z-40 w-64  h-screen pt-8 transition duration-1000 ease-out  -translate-x-full bg-primary-color border-r  border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
        aria-label='Sidebar'
      >
